...
export default function Home() {
  ...
  const t = {
    en: {
      ...
      updatesTitle: "What Changed This Month",
      updatesDesc: "Real-time legislative tracking distilled into plain English. We monitor 400+ federal and state sources so you don't have to.",
    ...
    es: {
      ...
      updatesTitle: "Lo que Cambió Este Mes",
      updatesDesc: "Seguimiento legislativo en tiempo real en inglés y español simple. Monitoreamos más de 400 fuentes gubernamentales.",
